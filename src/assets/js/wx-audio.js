/**
 * Created by shangxin on 2018-11-19 17:31
 */
export const Wxaudio = function () {
  let Wxaudio = function (options) {
    ...
    this.opt.ele = $('.bxx-audio-allInit')[options.ele];
    // }
  ...
  Wxaudio.prototype = {
    ...
    initDom: function () {
      ...
      this.wxAudio.setAttribute("preload","metadata")  //禁止预缓存
      // this.wxAudio.preload = 'auto'
      this.wxAudioC.appendChild(this.wxAudio)


      this.layoutTop = document.createElement('div')
      this.layoutTop.className = 'audio-layout-top'
      this.wxAudioC.appendChild(this.layoutTop)
      // left
      this.wxAudioL = document.createElement('div')
      this.wxAudioL.className = 'wx-audio-left'
      this.layoutTop.appendChild(this.wxAudioL)

      // left image
      this.wxAudioStateImg = document.createElement('img')
      this.wxAudioStateImg.className = 'wx-audio-state'
      this.wxAudioStateImg.src = require('./playing.png')
      ...
      this.layoutTop.appendChild(this.wxAudioR)
      ...
      //创建progrees 跟时间的总容器 跟时间
      this.progressTime = document.createElement('div')
      this.progressTime.className = 'progress-container'
      this.wxAudioC.appendChild(this.progressTime)
      ...
      this.progressTime.appendChild(this.wxAudioCurrent)


      //   progrees
      this.wxAudioP = document.createElement('div')
      this.wxAudioP.className = 'wx-audio-progrees'
      this.progressTime.appendChild(this.wxAudioP)
      // durationT
      ...
      this.progressTime.appendChild(this.wxAudioDuration)
    ...
    initAudioEvent: function () {
      ...
      _this.wxAudio.onplaying = function () {
        ...
        _this.wxAudioStateImg.src = require('./pause.gif')
      },
        _this.wxAudio.onpause = function () {
          _this.isPlaying = false
          _this.showLoading(false)
          _this.wxAudioStateImg.src = require('./playing.png')
        },
        ...
        // 页面点击事件
       /* _this.wxAudioStateImg.onclick = function (e) {
